...
class Students_model extends CI_Model{
        ...
        public function getStudents(){
          ...
          $strSQL = "SELECT STUD_ID, STUD_NAME, STUD_TEL, STUD_BD, STUD_PRNT_TEL, STUD_CLSS_ID, STUD_PRNT_TELL,
                            ...
                            CLSS_NAME, CLSS_YEAR, POST_NAME, POST_ABB, STUD_BARCODE
        ...
        public function getStudent_byID($ID){
          ...
          $strSQL = "SELECT STUD_ID, STUD_NAME, STUD_TEL, STUD_BD, STUD_PRNT_TEL, STUD_CLSS_ID, STUD_PRNT_TELL,
                            STUD_PRNT_NAME, STUD_MNTR_NAME, STUD_PREV_CLUB, STUD_FAV_POS, STUD_WGHT, STUD_LGTH,
                            CLSS_NAME, CLSS_YEAR, POST_NAME, STUD_ACCS_CODE, POST_ABB, STUD_BARCODE
                      FROM Students, classes, Positions
                      WHERE STUD_CLSS_ID = CLSS_ID
                      AND   STUD_FAV_POS = POST_ID
                      AND   STUD_ID = {$ID}";
        ...
        public function insertStudent($Name, $Tel, $BirthDate, $ParentTel, $ClassID, $ParentTel2, $ParentName, $MentorName, $PrevClub, $FavPos, $Weight, $Length, $Barcode){
          ...
          $strSQL = "INSERT INTO Students (STUD_NAME, STUD_TEL, STUD_BD, STUD_PRNT_TEL, STUD_CLSS_ID, STUD_PRNT_TELL, STUD_PRNT_NAME,
                                           STUD_MNTR_NAME, STUD_PREV_CLUB, STUD_FAV_POS, STUD_WGHT, STUD_LGTH, STUD_ACCS_CODE, STUD_BARCODE)
                     VALUES               (?, ?, ?, ?, ?, ?, ?, ?, ? , ?, ?, ?, 'TEMP', ?)";

          $inputs = array($Name, $Tel, $BirthDate, $ParentTel, $ClassID, $ParentTel2, $ParentName, $MentorName, $PrevClub, $FavPos, $Weight, $Length, $Barcode);
